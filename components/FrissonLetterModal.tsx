...
export default function FrissonLetterModal({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md rounded-[28px] border border-white/70 bg-white/90 px-7 py-8 shadow-2xl backdrop-blur-xl sm:px-8 sm:py-9"
      ...
      >
        ...
        <div className="mt-7 space-y-5 text-sm leading-7 text-neutral-700">
          <p>
          ...
          <p className="font-medium underline decoration-neutral-400 decoration-1 underline-offset-4">
            곡을 들으려면 레코드판 둘레의 닉네임을 먼저 누른 뒤, LP 가운데 라벨을 눌러 재생하거나
            일시정지할 수 있어요.
          </p>
